...
cluster_name = os.environ.get(
    "KUBERNETES_CLUSTER_ID", "k8s-1-33-1-do-3-sgp1-1754714430629"
)
# invalid version slug error fix the version looking at digital ocean console whats available.  # noqa: E501
version = "1.33.1-do.3"
